...
ARG VERSION=1.3
ARG SIGNALVERSION="0.12.4"
ARG LIBSIGVERSION="0.32.1"
...
RUN wget -qN https://github.com/AsamK/signal-cli/releases/download/v$SIGNALVERSION/signal-cli-$SIGNALVERSION.tar.gz -O signal-cli-$SIGNALVERSION.tar.gz && \
